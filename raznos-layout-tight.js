...
.footer-actions{position:sticky!important;bottom:calc(0px + var(--safe-bottom))!important;z-index:30!important;padding:5px!important;gap:6px!important;border-radius:15px!important;background:rgba(22,20,31,.90)!important;backdrop-filter:blur(12px)!important}.action-btn{min-height:40px!important;border-radius:14px!important}.action-btn strong{font-size:13px!important;line-height:1.04!important}.action-btn span{font-size:10px!important;margin-top:1px!important;line-height:1!important}
.rz-boss-compact{min-height:38px!important;padding:5px 9px!important;border-radius:14px!important;margin:0!important;display:flex!important;align-items:center!important;gap:8px!important}.rz-boss-compact p,.rz-boss-compact .desc,.rz-boss-compact .description{display:none!important}.rz-boss-compact .progress,.rz-boss-compact progress{height:4px!important;margin-top:3px!important}.rz-boss-compact *{line-height:1.05!important}.rz-boss-compact .rz-batenin-boss-icon{width:34px!important;height:34px!important;min-width:34px!important;border-radius:10px!important}
body.rz-late-level .app{gap:5px!important;padding-top:calc(4px + var(--safe-top))!important;padding-bottom:calc(8px + var(--safe-bottom))!important}body.rz-late-level .topbar{min-height:50px!important;padding:5px 10px!important}.rz-late-level .brand-title{font-size:15px!important}.rz-late-level .brand-sub{font-size:10px!important}.rz-late-level .badge{min-width:54px!important;padding:4px 6px!important}.rz-late-level .badge-label{font-size:8px!important}.rz-late-level .badge-value{font-size:16px!important}.rz-late-level .panel{padding:5px!important}.rz-late-level .goals-wrap{gap:4px!important}.rz-late-level .goal-chip{min-height:38px!important;padding:4px 6px!important;gap:6px!important}.rz-late-level .goal-icon{width:34px!important;height:34px!important;flex-basis:34px!important;border-radius:10px!important}.rz-late-level .goal-title{font-size:11px!important;line-height:1.03!important}.rz-late-level .goal-progress{font-size:10px!important}.rz-late-level .footer-actions{padding:5px!important}.rz-late-level .action-btn{min-height:38px!important}
...
function markBoss(){
  ...
  const candidates=[...document.querySelectorAll('.app > *, .board-shell > *')].filter(el=>{
    ...
    if(r.width<250||r.height<28||r.height>150)return false;
