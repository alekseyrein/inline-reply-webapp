...
.rz-boss-top-pill{position:absolute!important;left:8px!important;top:50%!important;transform:translateY(-50%)!important;display:none!important;align-items:center!important;gap:6px!important;z-index:5!important;pointer-events:none!important}.rz-boss-top-pill img{width:42px!important;height:42px!important;object-fit:cover!important;border-radius:12px!important;border:1px solid rgba(255,207,94,.42)!important;box-shadow:0 6px 14px rgba(0,0,0,.35)!important}.rz-boss-top-count{min-width:23px!important;height:23px!important;padding:0 6px!important;border-radius:999px!important;display:flex!important;align-items:center!important;justify-content:center!important;background:linear-gradient(135deg,#ffe27a,#a36b16)!important;color:#271704!important;font-size:12px!important;font-weight:900!important;border:1px solid rgba(255,236,160,.65)!important;box-shadow:0 4px 10px rgba(0,0,0,.3)!important;margin-left:-14px!important;margin-top:24px!important}.rz-boss-active .rz-boss-top-pill{display:flex!important}.rz-boss-active .brand{padding-left:56px!important;min-width:0!important}.rz-boss-active .brand-title{font-size:0!important;line-height:0!important}.rz-boss-active .brand-sub{font-size:10px!important;line-height:1.08!important;margin-top:0!important;max-width:112px!important}
...
function updateBossTop(hasBoss){
  ...
  if(!pill){pill=document.createElement('div'); pill.className='rz-boss-top-pill'; pill.innerHTML='<img alt=""><span class="rz-boss-top-count"></span>'; top.prepend(pill)}
